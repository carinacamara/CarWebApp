...
public class ClientStart {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			System.out.println("Selling price: " + taxService.computeSelling(new Car(2012,1000, 500)));
			System.out.println("Tax value: " + taxService.computeTax(new Car(2009, 2000, 500)));
		//	System.out.println(taxService.computeTax(new Car(2009, -100, 250)));
